  ...
  const renderClassScreen = () => {
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        {/* Tarih Seçici ve Kaydet Bölümü */}
        <View style={styles.dateControlsFrame}>
          <Text style={styles.sectionTitle}>Tarih ve Hafta Kontrolü</Text>
                  ...
                  Alert.alert(
                    ...
                    [
                      { text: 'Kaydetme', onPress: () => {
                        setHasUnsavedChanges(false);
                        setCurrentEditingWeek(null);
                        // newDate'in Date object olduğundan emin ol
              ...
              <>
                <View style={styles.weekInfo}>
                  <Text style={styles.weekInfoText}>
                    Seçili Hafta: {currentEditingWeek}. Hafta
                  </Text>
                </View>
                <TouchableOpacity
                  style={[
                    styles.saveButton,
                    hasUnsavedChanges ? styles.saveButtonUnsaved : styles.saveButtonNormal
                  ]}
                  onPress={saveWeeklyDataAndReset}
                >
                  <Text style={styles.saveButtonText}>
                    💾 KAYDET {hasUnsavedChanges ? '(Kaydedilmedi!)' : ''}
                  </Text>
                </TouchableOpacity>
              </>
            )}
